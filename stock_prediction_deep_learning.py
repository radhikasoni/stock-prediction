...
def train_LSTM_network(stock):
    ...
    # test_predictions_baseline = data.get_min_max().inverse_transform(test_predictions_baseline_padded)[:, 0]  # Extract only the first column
    ...
    predicted_close = min_max.inverse_transform(np.column_stack((
    ...
    actual_close = min_max.inverse_transform(np.column_stack((
    ...
    plotter.project_plot_predictions(predicted_close, actual_close)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-github_url", default="https://github.com/radhikasoni/stock-prediction.git/")
