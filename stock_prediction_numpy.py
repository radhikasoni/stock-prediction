...
class StockData:
    ...
    def download_transform_to_numpy(self, time_steps, project_folder, predict):
    ...
    def generate_future_data(self, time_steps, min_max, start_date, end_date, latest_close_price, predict):
        x_future = []
        y_future = []
        ...
        test_data = pd.DataFrame({'Datetime': x_future, predict: y_future})
        test_data = test_data.set_index('Datetime')
